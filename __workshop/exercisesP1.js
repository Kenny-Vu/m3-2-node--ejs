...
const q4 = (req, res) => {
  ...
  [olivia, ruby, emily] = popularGirlNames;
  res.render("pages/question4", { olivia, ruby, emily });
};
...
const q5 = (req, res) => {
  const popularGirlNames = ["Olivia", "Ruby", "Emily", "Grace", "Jessica"];
  const topTitle = "Top 5 girls names in the England and Wales";
  res.render("pages/question5", { popularGirlNames, topTitle });
};
